  ...
  return (
    <>
      ...
      <form >
        ...
        <Link href="/clientDetails" className="btn btn-primary mt-4 bg-red-500 rounded-full hover:bg-red-700 border border-red-500 hover:border-red-700 text-white ">Submit</Link>
      </form>
      </div>
    </div>
    </>
